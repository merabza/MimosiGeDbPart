...
public sealed class LessonConfiguration : IEntityTypeConfiguration<Lesson>
{
    public void Configure(EntityTypeBuilder<Lesson> builder)
    {
        ...
        builder.Property(e => e.LessonDt).HasPrecision(0).HasComment("ჩატარების თარიღი და დრო");
        builder.Property(e => e.Note).HasMaxLength(255).HasComment("შენიშვნა");
        builder.Property(e => e.RecoverDate).HasPrecision(0).HasComment("აღდგენა");
        ...
        builder.Property(e => e.TeoMaxDate).HasPrecision(0).HasComment(
            "ჯგუფში დროების განაწილების მიხედვით თეორიულად მაქსიმალური თარიღი იმ თვისთვის, როცა ეს გაკვეთილი ჩატარდა");
        builder.Property(e => e.TeoMinDate).HasPrecision(0).HasComment(
