...
public sealed class MimosiGeDbContext : CarcassDbContext
{
    ...
    public MimosiGeDbContext(DbContextOptions<MimosiGeDbContext> options, bool isDesignTime) : base(options, isDesignTime)
    {
        //Console.WriteLine("MimosiGeDbContext Constructor 2...");
    }
    
    public MimosiGeDbContext(DbContextOptions<MimosiGeDbContext> options, int int1) : base(ChangeOptionsType<CarcassDbContext>(options), int1)
    {
        //Console.WriteLine("MimosiGeDbContext Constructor 3...");
    }
    
    public MimosiGeDbContext(DbContextOptions<MimosiGeDbContext> options) : base(ChangeOptionsType<CarcassDbContext>(options))
    {
